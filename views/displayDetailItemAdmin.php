    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 ml-64 p-6">
            ...
            <div class="flex justify-start mb-1 mt-2">
                <a href="./views/formNewItem.php" class="inline-block px-3 py-3 bg-blue-600 text-white font-semibold text-lg rounded-md hover:bg-blue-700 transition duration-300 ease-in-out">
                    Insert new item
                </a>
            </div>
