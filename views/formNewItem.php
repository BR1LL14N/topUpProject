...
<body class="bg-gray-100">
    <div class="container mx-auto py-8">
        ...
        <!-- Form -->
        <form class="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md" action="../index.php?modul=itemGame&fitur=add" method="POST" enctype="multipart/form-data">
        <!-- Game Name -->
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="game_name">Item Name</label>
        ...
        <!-- Game Description -->
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2" for="game_description">Item Description</label>
