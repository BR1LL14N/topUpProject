                ...
                <div class="game-cards-container my-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 items-center">
                    <?php foreach ($result as $row) : ?>
                        <div class="relative group game-card bg-white shadow-lg rounded-lg p-4 flex flex-col items-center">
                            ...
                            <a href="./index.php?gameID=<?php echo $row['game_id']; ?>&modul=gameAndItem&fitur=deleteRequest" 
                            ...
                            <a href="./index.php?gameID=<?php echo $row['game_id']; ?>&modul=gameAndItem&fitur=requestUpdate" 
                            ...
                            <!-- Gambar Game -->
                            <a href="index.php?gameID=<?php echo $row['game_id']; ?>&modul=itemGame&fitur=display">
                                <img 
