                ...
                <?php endif; ?>
                    ...
                    <?php foreach ($result as $row) : ?>
                        <div class="relative group game-card bg-white shadow-lg rounded-lg p-4 flex flex-col items-center">
                            ...
                            <a href="./index.php?gameID=<?php echo $row['payment_id']; ?>&modul=gameAndItem&fitur=deleteRequest" 
                            ...
                            <a href="./index.php?gameID=<?php echo $row['payment_id']; ?>&modul=gameAndItem&fitur=requestUpdate" 
